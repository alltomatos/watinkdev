...
const tenantSmtpSettingsRoutes_1 = __importDefault(require("./tenantSmtpSettingsRoutes"));
...
const stepRoutes_1 = __importDefault(require("./stepRoutes"));
const emailTemplateRoutes_1 = __importDefault(require("./emailTemplateRoutes"));
...
routes.use("/mobile/v1", mobileRoutes_1.default);
...
routes.use(tenantSmtpSettingsRoutes_1.default);
routes.use(emailTemplateRoutes_1.default);
routes.use(WebchatRoutes_1.default);
