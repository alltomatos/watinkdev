...
const dispatcherVersionRoutes_1 = __importDefault(require("./dispatcherVersionRoutes"));
...
const smtpSettingsRoutes_1 = __importDefault(require("./smtpSettingsRoutes"));
...
routes.use(dispatcherVersionRoutes_1.default);
...
routes.use(smtpSettingsRoutes_1.default);
