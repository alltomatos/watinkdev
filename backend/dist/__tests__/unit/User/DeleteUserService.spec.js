...
describe("User", () => {
    ...
    it("should be delete a existing user", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((0, DeleteUserService_1.default)(id, { id: 1, profile: "admin", tenantId: 1 })).resolves.not.toThrow();
    }));
    it("to throw an error if tries to delete a non existing user", () => __awaiter(void 0, void 0, void 0, function* () {
        expect((0, DeleteUserService_1.default)(faker_1.default.random.number(), {
            id: 1,
            profile: "admin",
            tenantId: 1
