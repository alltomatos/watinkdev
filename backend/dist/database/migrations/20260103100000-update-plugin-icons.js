...
module.exports = {
    up: async (queryInterface) => {
        ...
        await queryInterface.bulkUpdate("Plugins", { iconUrl: "/assets/plugins/whatsmeow/icon.png" }, { slug: "whatsmeow" });
    },
    down: async (queryInterface) => {
        ...
        await queryInterface.bulkUpdate("Plugins", { iconUrl: "https://plugins.watink.com/whatsmeow/icon.png" }, { slug: "whatsmeow" });
    }
};
